...
### 🔹 Step 2: Move the time derivative inside the integral
...
### 🔹 Step 3: The local (pointwise) conservation law

**Acharya:** Now, Pavni, what does this equation tell us?

**Pavni:** It says that the integral of $\rho_t + q_x$ over *any* interval is zero.

**Acharya:** Exactly! And that can only happen if the integrand itself is zero *everywhere* — otherwise, we could find an interval where it’s positive or negative.  
