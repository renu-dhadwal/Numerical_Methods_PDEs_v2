...
**Pavni:** Acharya, last time we derived the equation  
$$
\rho_t + a\rho_x = 0, \quad a > 0,
$$  
for cars moving at constant speed. But how do we actually find $\rho(x,t)$ from this?
...
### 1️⃣ Deriving the Characteristic Curves
...
### 2️⃣ The Meaning of Characteristics
...
### 4️⃣ Understanding Finite Propagation Speed
...
### 6️⃣ Visualizing Characteristics
