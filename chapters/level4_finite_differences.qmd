...
:::
---
title: "Finite Differences — Heat equation example"
execute:
  echo: true   # show code in the page
  eval: true   # run the code during render
  freeze: auto # cache outputs when possible
---
...
# build A (interior) and b (boundary forcing)
m = Nx - 2
