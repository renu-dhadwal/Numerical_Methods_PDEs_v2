...
$$
\lambda_k = 1-2r + 2r\cos\!\Big(\tfrac{k\pi}{N_x-1}\Big),
\qquad k=1,\dots,N_x-2.
$$

The most negative eigenvalue occurs when $\cos(\theta)=-1$, giving
$$
\lambda_{\min} = 1 - 4r.
$$

Requiring $|\lambda_k|\le 1$ for all $k$ leads to the condition
$$
0 \;\le\; r \;\le\; \tfrac{1}{2}.
$$
