...
3. The **shape** (concavity) that satisfies the diffusion balance.
## Exercises — Exploring the effect of sources and boundary conditions
...
1. **Non-homogeneous Dirichlet boundary:**  
   Keep $$f(x,y)=1$$ but set  
   $$u=100$$ on the left edge ($x=0$) and $$u=0$$ elsewhere.  
